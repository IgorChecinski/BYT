...
public class Money implements Comparable {
	...
	public String toString() {
		double moneyform = (double)this.amount/100;
        return moneyform + " " + this.currency.getName();
	}
	...
	public Money add(Money other) {
		double first = this.universalValue();
		double second = other.universalValue();
	...
	Integer otherValue = otherMoney.universalValue();
