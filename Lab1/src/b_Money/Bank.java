...
public class Bank {
	...
	public void openAccount(String accountid) throws AccountExistsException {
		if (accountlist.containsKey(accountid)) {
			 ...
			 * get doesn't make sense because we want to add new account not get anything.
			 * Method doesn't return anything anyway.
	...
	public void withdraw(String accountid, Money money) throws AccountDoesNotExistException {
		if (!accountlist.containsKey(accountid)) {
			...
			Account account = accountlist.get(accountid);
			/**
			 Deposit doesn't make sense when we withdraw the money
			 test said that withdrawing 500 from balance 0 is 500
			 */
